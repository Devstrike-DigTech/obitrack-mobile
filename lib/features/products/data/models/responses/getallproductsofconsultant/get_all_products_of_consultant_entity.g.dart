...
part of 'get_all_products_of_consultant_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetAllProductsOfConsultantEntity _$GetAllProductsOfConsultantEntityFromJson(
        Map<String, dynamic> json) =>
    GetAllProductsOfConsultantEntity(
      (json['products'] as List<dynamic>)
          .map((e) => GetAllProductsOfConsultantProductsEntity.fromJson(
...
Map<String, dynamic> _$GetAllProductsOfConsultantEntityToJson(
        GetAllProductsOfConsultantEntity instance) =>
    <String, dynamic>{
...
GetAllProductsOfConsultantProductsEntity
    _$GetAllProductsOfConsultantProductsEntityFromJson(
            Map<String, dynamic> json) =>
        GetAllProductsOfConsultantProductsEntity(
          ...
          GetAllProductsOfConsultantProductsOrganisationEntity.fromJson(
              json['organisation'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$GetAllProductsOfConsultantProductsEntityToJson(
        GetAllProductsOfConsultantProductsEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
GetAllProductsOfConsultantProductsOrganisationEntity
    _$GetAllProductsOfConsultantProductsOrganisationEntityFromJson(
            Map<String, dynamic> json) =>
        GetAllProductsOfConsultantProductsOrganisationEntity(
          (json['id'] as num).toInt(),
          json['name'] as String,
...
Map<String, dynamic>
    _$GetAllProductsOfConsultantProductsOrganisationEntityToJson(
            GetAllProductsOfConsultantProductsOrganisationEntity instance) =>
        <String, dynamic>{
          'id': instance.id,
          'name': instance.name,
