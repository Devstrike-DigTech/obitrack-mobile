...
part of 'update_product_response_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UpdateProductResponseEntity _$UpdateProductResponseEntityFromJson(
    ...
    UpdateProductResponseEntity(
      ...
      UpdateProductResponseOrganisationEntity.fromJson(
          json['organisation'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$UpdateProductResponseEntityToJson(
        UpdateProductResponseEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
UpdateProductResponseOrganisationEntity
    _$UpdateProductResponseOrganisationEntityFromJson(
            Map<String, dynamic> json) =>
        UpdateProductResponseOrganisationEntity(
          (json['id'] as num).toInt(),
          json['name'] as String,
...
Map<String, dynamic> _$UpdateProductResponseOrganisationEntityToJson(
        UpdateProductResponseOrganisationEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
