...
SearchProductResponseEntity _$SearchProductResponseEntityFromJson(
    ...
    SearchProductResponseEntity(
      ...
      SearchProductResponseOrganisationEntity.fromJson(
...
SearchProductResponseOrganisationEntity
    _$SearchProductResponseOrganisationEntityFromJson(
            Map<String, dynamic> json) =>
        SearchProductResponseOrganisationEntity(
          (json['id'] as num).toInt(),
          json['name'] as String,
...
Map<String, dynamic> _$SearchProductResponseOrganisationEntityToJson(
        SearchProductResponseOrganisationEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
