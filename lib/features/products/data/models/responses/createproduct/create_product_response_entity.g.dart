...
part of 'create_product_response_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CreateProductResponseEntity _$CreateProductResponseEntityFromJson(
    ...
    CreateProductResponseEntity(
      ...
      CreateProductResponseOrganisationEntity.fromJson(
          json['organisation'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CreateProductResponseEntityToJson(
        CreateProductResponseEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
CreateProductResponseOrganisationEntity
    _$CreateProductResponseOrganisationEntityFromJson(
            Map<String, dynamic> json) =>
        CreateProductResponseOrganisationEntity(
          (json['id'] as num).toInt(),
          json['name'] as String,
...
Map<String, dynamic> _$CreateProductResponseOrganisationEntityToJson(
        CreateProductResponseOrganisationEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
